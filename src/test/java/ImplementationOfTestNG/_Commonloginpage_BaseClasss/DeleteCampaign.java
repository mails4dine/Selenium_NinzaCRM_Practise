...
public class DeleteCampaign extends BaseClass1 {
    ...
    public void deleteCampaignsTest() {
       // CampaignPage campaignPage = new CampaignPage(driver);
        ...
        select.selectByVisibleText("Search by Campaign Name");

        WebElement textfield = driver.findElement(By.xpath("//input[@placeholder='Search by Campaign Name']")); 
        wutil.waitForVisibilityofElement1(driver, textfield);
        textfield.sendKeys("JoseJohn");
     ...
     // --- STEP 3: OPTIMIZED DYNAMIC LOOP ---
        ...
        Reporter.log("Total :"+ count  + " Campaign's Deleted Successfully ", true);
